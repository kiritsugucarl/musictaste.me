...
const MusicPersonality = () => {
    ...
    return (
        <main className="container content-container section">
            <div className="musicPersonality-wrapper">
                ...
                <div className="musicPersonality__addedSongs-wrapper">
                    <h2 className="musicPersonality__addedSong-title">
                        ADDED SONGS
                    </h2>
                    <ul className="musicPersonality__addedSong-songList">
                        {addedSongs.map((song, index) => (
                            <li
                                key={song.id}
                                className="musicPersonality__addedSong-songList-item"
                            >
                                <p className="musicPersonality__addedSong-songList-iteration">
                                    {index + 1}
                                </p>
                                <img
                                    className="musicPersonality__addedSong-songList-songAlbumImg"
                                    src={song.album.images[0].url}
                                />
                                <div className="musicPersonality__addedSong-songList-details-wrapper">
                                    <p className="musicPersonality__addedSong-songList-songName">
                                        {song.name}
                                    </p>
                                    <p className="musicPersonality__addedSong-songList-songDetails">
                                        {song.artists.map(
                                            (artist) => artist.name
                                        )}{" "}
                                        -{song.album.name} (
                                ...
                                <button
                                    className="musicPersonality__addedSong-songList-removeButton"
                                    onClick={() =>
                                        removeSongFromAddedList(song)
                                    }
                                >
                                    <svg
                                        className="musicPersonality__addedSong-songList-removeButtonImg"
                    ...
                    <button
                        onClick={getResults}
                        className="musicPersonality__addedSongs-getResultBtn"
                    >
                        Get Result
                    </button>
                </div>
